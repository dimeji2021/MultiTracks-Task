<%@ Page Language="C#" AutoEventWireup="true" CodeFile="artist-details.aspx.cs" Inherits="PageToSync_artistDetails" %>
...
<body>
                ...
                <div class="wrapper mod-standard mod-gray">
                    ...
                    <nav class="discovery--nav">
                        <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                            ...
                            <li class="discovery--nav--list--item tab-filter--item">
                                <a class="tab-filter" href="<%# "../PageToSync/artists/albums/details.aspx?id="+Eval("artistID")%>">Albums</a>
                            </li>
                        </ul>
                        ...
                        <main class="discovery--section">
                            ...
                            <section class="standard--holder">
                                <div class="discovery--section--header">
                                    <h2>Top Songs</h2>
                                    <a class="discovery--section--header--view-all" href="<%# "../PageToSync/artists/songs/details.aspx?id="+Eval("artistID")%>">View All</a>
                                </div>
                                <!-- /.discovery-select -->

                                <ul id="playlist" class="song-list mod-new mod-menu">
                                    <asp:Repeater ID="rptTopSongs" runat="server">
                                        <ItemTemplate>
                                            <li class="song-list--item media-player--row">

                                                <div class="song-list--item--player-img media-player">
                                                    <img class="song-list--item--player-img--img"
                                                        srcset="<%# Eval("albumImage") %> 2x"
                                                        src="<%# Eval("albumImage") %>" alt="<%# Eval("albumTitle") %>">
                                                </div>
                            ...
                            <div class="discovery--space-saver">
                                <section class="standard--holder">
                                    <div class="discovery--section--header">
                                        <h2>Albums</h2>
                                        <a class="discovery--section--header--view-all" href="<%# "../PageToSync/artists/albums/details.aspx?id="+Eval("artistID")%>">View All</a>
                                    </div>
                                    <!-- /.discovery-select -->
                            ...
                            <section class="standard--holder">
                                ...
                                <div class="artist-details--biography biography">
                                    <p id="partial-bio">
                                        <%# new String(Eval("biography").ToString().Take(500).ToArray()) + "..." %>
                                    </p>
                                    <p id="full-bio" style="display: none;">
                                        <%#Eval("biography") %>
                                    </p>
                                    <a href="#"  id="toggle-bio-link">Read More...</a>
                                </div>
                            </section>
                        </main>
                    </div>
    ...
    <script>
        var toggleBioLink = document.getElementById("toggle-bio-link");
        var partialBio = document.getElementById("partial-bio");
        var fullBio = document.getElementById("full-bio");

        toggleBioLink.addEventListener("click", function (event) {
            event.preventDefault();
            if (fullBio.style.display === "none") {
                fullBio.style.display = "block";
                partialBio.style.display = "none";
                toggleBioLink.innerHTML = "Read Less";
            } else {
                fullBio.style.display = "none";
                partialBio.style.display = "block";
                toggleBioLink.innerHTML = "Read More";
            }
        });
    </script>
</body>
